...
angular.module('app.localization', []).
    factory('Localization', ['$http', '$rootScope', '$window', '$filter', function ($http, $rootScope, $window, $filter) {
    var localize = {
        ...
        initLocalizedResources:function () {
            ...
            $http({ method:"GET", url:url, cache:false }).success(localize.successCallback).error(function () {
                ...
                var url = 'lib/localization/resources-locale_default.js';
    ...
    filter('localization', ['Localization', function (Localization) {
    return function (input) {
        return Localization.getLocalizedString(input);
    };
}]);