...
describe('HttpService',function(){
	...
	it('Testing if the login request returns a promise object',inject(function(HttpService){
		...
		var promise = HttpService.request('https://agora-test.uninett.no/api/secure/jsonws/company/get-company-by-virtual-host/virtual-host/agora.uninett.no','','GET');
	...
	it('Testing if the login gets resolved with correct login info',inject(function(HttpService){
		...
		var promise = HttpService.request('https://agora-test.uninett.no/api/secure/jsonws/company/get-company-by-virtual-host/virtual-host/agora.uninett.no','Basic dGVzdFVzZXI6ZGVtbw==','GET');
	...
	it('Testing if the login get rejected with wrong login info',inject(function(HttpService){
		//set request url customized authorization and request method
		var promise = HttpService.request('https://agora-test.uninett.no/api/secure/jsonws/company/get-company-by-virtual-host/virtual-host/agora.uninett.no','Basic ','GET');
